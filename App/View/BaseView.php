...
<html>
    <head>
        ...
        <link type = "text/css" rel="stylesheet" href="View/Styles/general.css">
    ...
    <header>
        ...
        <menu>
            ...
            <li><a href = "index.php?controller=GameDetail&action=playerStats">Statistiques joueur</a></li>
            <li><a href = "index.php?controller=GameDetail&action=corporationStats">Statistiques corporation</a></li>
